...
-- Now you can place your cursor on any of them and then press the [Value] or [Type] buttons below
-- to get their values or types
...
-- ...to see their kind, using the [Kind] button below

-- You can define functions too, let's try (once again) with the well known fact...

fact x = foldl (*) 1 [1..x]

-- Now if you place your cursor on the next instruction, you can ask for their values or types
