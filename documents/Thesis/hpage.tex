...
%%TODO: Explicar caso de m—dulos precomiplados
  A partir de este momento, F'atima utiliza su editor favorito para trabajar en el m'odulo que ha creado y, ante cada modificaci'on del mismo, lo recarga utilizando la opci'on \textsl{Haskell $\rightarrow$ Reload} o el bot'on \textsl{Reload}.
...
%%TODO: Aclarar que busca en los src-dirs si hay un paquete y sino en el directorio actual
